...
"""
    This file is part of CheapStresser-IP-Tracer tool.
    Copyright (C) 2015-2016 @water_hosting
    https://github.com/DemonLayer/CheapStresser-IP-Tracer
    
    CheapStresser-IP-Tracer - Retrieve IP Geolocation information 
...
import sys, os
from core.CheapStresserIPTracerLib import CheapStresserIPTracerLib
...
def main():
    ...
    #init lib
    ipGeoLocRequest = LocationIpGeoLib(args.target, logger, args.noprint)
